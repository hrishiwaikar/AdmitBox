...
class University :
    ...
    def __init__(self,id):
        ...
        self.list = None
        self.admitfilename= str(id)+'A.csv' #admitfilename
        self.rejectfilename= str(id)+'R.csv' #reject file name
        self.admissionslistfilename =str(id)+'L.csv'  #filename of the pickle file that stores the admissions list that was generated post
                                     #preprocessing
        self.svm_classifier_filename =str(id)+'_SVM_C.p'  #name of pickle file in which classifier will be saved
...
def inference_manager(sample,name):
        ...
        '''
        global af
        af = open(str(name)+'_report.txt','w')
        ...
        for i in universityFiles:
            try:
                ...
                print str(i)+' '+str(universityFiles[i])+' object file not found'
